...
from src.numba_wrapper.numba_testing_wrapper import testable_jit


@testable_jit(nopython=True)
def numba_extremes_index(array: NDArray) -> Tuple[int, int]:
    """
...
def numba_extremes(array: NDArray) -> Tuple[float, float]:
